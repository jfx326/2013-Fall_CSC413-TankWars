...
public class Player1 implements Observer {
    ...
    private int x, y, w, h, // position, width, height
            ...
            angle = 30, // angle of turret (angle * 6 = true angle in degrees)
            health = 16,
    ...
    Player1(Image img, int x, int y) {
        ...
        shld = Tank.r.getSprite("Resources/Element/Shield1.png");
        life = Tank.r.getSprite("Resources/Element/T1Life.png");
        ...
        for (int i = 0; i < 10; i++) {
            ...
            timg.add(Tank.r.getSprite("Resources/T1/T1-0" + i + ".png"));
        }
        ...
        for (int i = 10; i < 60; i++) {
            ...
            timg.add(Tank.r.getSprite("Resources/T1/T1-" + i + ".png"));
        }
    ...
    public void draw(Graphics g, ImageObserver obs) {
        ...
        if (!boom && lives > 0) { // draw tank if not destroyed and has lives
            ...
            health = 0;
            Tank.r.setGameOver(true); // p2 wins
        ...
        if (ready) {
            ...
            if (fire) {
                if (fireTime == 0) {
                    ...
                    Tank.pBullet1.add(new PlayerBullet(pb, x + 22, y + 20, 1));
                    fireTime++;
                } else if (fireTime == 14) {
                    fireTime = 0;
                } else {
